...
author: "ASSANELLI Franco [acá KUZMINSKI Nicolás tiene que poner él mismo su nombre, como cuando un ingeniero o un arquitecto ponen la firma del puente construido]"
format: html
editor: visual
---
...
A partir del análisis realizado, se concluye que el criterio de diagnóstico de tumor maligno se ve explicado de manera significativa por la forma del tumor y, en particular, por la observación y modelado de concavidades en el tumor. También, [no sé si agregar algo más].